...
?>
	...
	<p class="lead">Veuillez appuyer sur Acheter pour confirmer votre achat ou Continuer vos achats pour ajouter ou supprimer des articles.</p>
<?php
	} else {
		echo "<p class=\"text-warning\">Votre panier est vide! Assurez-vous d'ajouter quelques livres!</p>";
	}
