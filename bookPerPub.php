<?php
	...
	if(mysqli_num_rows($result) == 0){
		echo "Livres vides! Veuillez patienter jusqu'à l'arrivée de nouveaux livres!";
		exit;
	}
...
?>
	<p class="lead"><a href="publisher_list.php">Éditeur</a> > <?php echo $pubName; ?></p>
...
?>
	<div class="row">
		...
		<div class="col-md-7">
			...
			<a href="book.php?bookisbn=<?php echo $row['book_isbn'];?>" class="btn btn-primary">Voir les details</a>
		</div>
	</div>
	<br>
<?php
